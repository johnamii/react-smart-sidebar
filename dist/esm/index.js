...
var css_248z = ".sidebar-container{\r\n  height: 100vh;\r\n  border-right: 1px solid #757F95;\r\n  font-size: 60%;\r\n  position:fixed;\r\n  left:0em;\r\n  top:0em;\r\n}\r\n\r\n.scroll-view{\r\n  display:flex;\r\n  flex-direction: column;\r\n  align-items:center;\r\n}\r\n\r\n.tab{\r\n  height: 3em;\r\n  background-color: transparent;\r\n  border: 1px solid;\r\n  color: white;\r\n  border-radius: 1em;\r\n  margin: .69em;\r\n  \r\n  display:flex;\r\n  align-items: center;\r\n  font-size:1.5em;\r\n}\r\n\r\n.icon-image{\r\n  height: 75%;\r\n}\r\n\r\n.group-wrapper{\r\n  width:100%;\r\n  display: flex;\r\n  flex-direction: column;\r\n\r\n  margin-top: 1.5em;\r\n  margin-bottom:1.5em;\r\n}\r\n\r\n.group-button{\r\n  background:none;\r\n  border:none;\r\n  display:flex;\r\n  align-items: center;\r\n  height: 3em;\r\n  width: 100%;\r\n  max-width: 4.5em;\r\n}\r\n\r\n.collapse-arrow{\r\n  height: 35%;\r\n  margin-left: 5px;\r\n  margin-top: 5px;\r\n  \r\n  fill:white;\r\n}\r\n\r\n.group-container{\r\n  width: 100%;\r\n  \r\n  border-left: 2px solid;\r\n  display:flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n}\r\n\r\n.divider-bar{\r\n  width: 75%;\r\n  height: 1px;\r\n  background: #757F95;\r\n  margin-top:2em;\r\n  margin-bottom:1em;\r\n}\r\n\r\n.menu-button{\r\n  height: 2rem;\r\n  fill:white;\r\n  position: fixed;\r\n  bottom: 0.9rem;\r\n  left: 0.9rem;\r\n}";
styleInject(css_248z);

const Divider = (props) => {
    var _a;
    const styles = {
        background: (_a = props.background) !== null && _a !== void 0 ? _a : '#757F95'
    };
    return (React.createElement("div", { className: 'divider-bar', style: styles }));
};
const Tab = (props) => {
    var _a, _b;
    const styles = {
        ...
        borderColor: (_a = props.accent) !== null && _a !== void 0 ? _a : '#757F95',
        background: (_b = props.background) !== null && _b !== void 0 ? _b : 'none'
    };
    return (React.createElement("button", { className: 'tab', style: styles, onClick: (val) => {
            props.onClick && props.onClick(val);
            props.url && window.open(props.url, "_self");
        } },
        React.createElement("img", { src: props.img, alt: props.name, className: 'icon-image' }),
...
const Group = (props) => {
    ...
    const styles = {
        color: (_a = props.accent) !== null && _a !== void 0 ? _a : 'lightskyblue',
        borderColor: (_b = props.accent) !== null && _b !== void 0 ? _b : 'lightskyblue',
    ...
    return (React.createElement("div", { className: 'group-wrapper', style: styles },
        React.createElement("button", { className: 'group-button', onClick: () => setCollapsed(!collapsed), style: styles },
            React.createElement("b", { style: props.ext ? { fontSize: '150%' } : { fontSize: '100%' } }, props.name),
            props.ext && React.createElement("img", { className: 'collapse-arrow', src: '/down_arrow.png', style: rotateArrow, alt: 'down' })),
        !collapsed &&
            React.createElement("div", { className: 'group-container', style: styles }, React.Children.map(props.children, (child, i) => {
...
const SideBar = (props) => {
    ...
    const menuButton = React.createElement("img", { src: "/menu.png", alt: "Hide Menu", className: 'menu-button', onClick: () => setVisible(!visible) });
    const styles = {
        background: (_a = props.background) !== null && _a !== void 0 ? _a : '#1e2127',
        boxShadow: extended && '2px 0px 10px 2px rgba(0,0,0,.5)',
        fontSize: (_b = props.size) !== null && _b !== void 0 ? _b : '55%'
    };
    return visible ? (React.createElement("div", { className: 'sidebar-container', onMouseEnter: () => setTimeout(() => setExtended(true), 150), onMouseLeave: () => setTimeout(() => setExtended(false), 150), style: styles },
        React.createElement(lib.Scrollbars, { autoHeight: true, autoHeightMin: '100vh', renderView: props => React.createElement("div", Object.assign({}, props, { className: "scroll-view" })) },
...
export { Divider, Group, SideBar, Tab };
